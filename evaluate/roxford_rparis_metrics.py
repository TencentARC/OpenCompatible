...
def calculate_mAP_roxford_rparis(logger, ranks, gnd, kappas=[1, 5, 10]):
    gnd_t = []
    ...
    logger.info(
        '>> mAP E: {}, M: {}, H: {}'.format(np.around(mapE * 100, decimals=2), np.around(mapM * 100, decimals=2),
                                            np.around(mapH * 100, decimals=2)))
    logger.info('>> mP@k{} E: {}, M: {}, H: {}'.format(kappas, np.around(mprE * 100, decimals=2),
